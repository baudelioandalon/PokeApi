package com.testexample.utils.util.roundablelayout
...
import com.testexample.utils.R
            ...
            context.obtainStyledAttributes(it, R.styleable.RoundableLayout).apply {
                ...
                dashLineWidth =
                    getDimensionPixelSize(R.styleable.RoundableLayout_dashLineWidth, 0)
                        .toFloat()
                dashLineGap =
                    getDimensionPixelSize(R.styleable.RoundableLayout_dashLineGap, 0).toFloat()
                cornerLeftSide =
                ...
                cornerRightSide =
                    getDimensionPixelSize(R.styleable.RoundableLayout_cornerRightSide, 0)
                        .toFloat()
                if (getDimensionPixelSize(R.styleable.RoundableLayout_cornerAll, 0) != 0) {
                    val roundedSize =
